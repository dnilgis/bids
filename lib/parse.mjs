 ...
 *
 * Pure ES module with no dependencies so it runs identically in a Cloudflare
 * Worker and in Node for the test suite.
 */
...
/** "459-4" -> 459.5 ; "+0-4" -> 0.5 ; plain numbers pass through. */
