 ...
 *
 * A BODY OF IT HAS NOW BEEN CAPTURED — 2026-08-29, run 90064858519. Riceland
 * answered on that address with 71,864 characters beginning:
 *
 *   {"data":[{"location_id":87191,
 *             "bushel_location_id":"66bc5eae-5b7e-45f4-8724-651462e7bca1",
 *             "location_name":"Corning",
 *             "sales_series_id":"57a824b8-d1ea-49b0-9b18-faef359d67a0",
 *             "crops":[{"id":"e9a998c9-78 ...
 *
 * So the UUID a source file needs is `bushel_location_id`, and the shape nests
 * under `data` rather than `locations`. THAT IS STILL NOT ENOUGH TO WRITE THE
 * BRANCH: 200 characters is one location's opening brace and the `crops` array
 * -- where the prices are -- has not been seen. describe() below now prints as
 * much of the body as BUSHEL_DESCRIBE_CHARS asks for, and the probe workflow
 * has a box that turns it up. Read a whole location first, then write the code.
 */
