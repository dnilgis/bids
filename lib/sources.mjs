...
export const PLATFORMS = ["cashbidssingle", "aghost", "fragment", "graindesk", "dtn-cs", "first-party"];
 ...
 * See lib/cdp.mjs. */
export const PLATFORM_TRANSPORT = { "dtn-cs": "browser" };
...
export const CASH_ROUNDING_MODES = ["exact", "floor-cent"];
